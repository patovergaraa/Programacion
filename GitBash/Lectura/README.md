...
Flujo de trabajo básico con un repositorio remoto parte 8 <br>
...
Comandos para trabajo remoto con GIT<br>
```sh
...
Introducción a las ramas o branches de Git parte 9 <br>
...
```
¿Cómo realizar un merge en git?<br>
```sh
...
#Hacemos cambios estando en la rama master, en el archivo de trabajo<br>
```sh
ctrl  + s
git status
git add .
...
# Por último les quiero hablar del 2FA: Segundo Factor de Autenticación
...
4. GitHub Mobile: GitHub Mobile can be used for two-factor authentication by installing the GitHub Mobile app and signing in to your account.
...
Esto para agregar a través de un QR una app que genere cada 1 segundo nuevos códigos numéricos para la autenticación, yo recomiendo la aplicación:
...
Agregar esta clase al README.md con el lenguaje Markdown, como lo hicimos en la clase pasada, luego deben hacer el commit correspondiente al cambio agregado, esto dentro de la carpeta git o class-git, según el nombre que hayas elegido, ahí debe estar el README.md con todos los comandos, con todas las clases que hemos hecho.
